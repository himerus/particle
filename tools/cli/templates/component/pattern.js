...
// Module template
import './_{{ dashCase name }}.twig';

export const name = '{{ camelCase name }}';

export const defaults = {
  dummyClass: 'js-{{ camelCase name }}-exists',
};
...
export function enable($context, { {{ camelCase name }} = {} }) {
  ...
  const settings = Object.assign(defaults, {{ camelCase name }});
  // An example of what could be done with this component
  ${{ camelCase name }}.addClass(settings.dummyClass);
}
